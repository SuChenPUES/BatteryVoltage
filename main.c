...
static char *cal_voltage_case1()
{
	...
	{
		mu_assert("error voltage value !", abs(cal_voltage(VB1[i]) - test_case1[i]) <= (1e-7));
	}
...
static char *cal_voltage_case2()
{
	...
	for (i = 0; i < num_step; i ++)
	{
		mu_assert("error voltage value !", abs(cal_voltage(VB2[i]) - test_case2[i]) <= (1e-7));
	}
...
static char *cal_voltage_case3()
{
	...
	for (i = 0; i < num_step; i ++)
	{
		mu_assert("error voltage value !", abs(cal_voltage(VB3[i]) - test_case3[i]) <= (1e-7));
	}
...
static char *cal_voltage_case4()
{
	...
	for (i = 0; i < num_step; i ++)
	{
		mu_assert("error voltage value !", abs(cal_voltage(VB4[i]) - test_case4[i]) <= (1e-7));
	}
...
static char *cal_voltage_case5()
{
	...
	for (i = 0; i < num_step; i ++)
	{
		mu_assert("error voltage value !", abs(cal_voltage(VB5[i]) - test_case5[i]) <= (1e-7));
	}
